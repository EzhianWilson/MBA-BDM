-- CREATING A NEW DATABASE "ONLINE_STORE"
create Database online_store;

-- ACCESSING THE "ONLINE_STORE" DATABASE
use online_store;

-- CREATING CUSTOMER TABLE WITH APPROPRIATE DATA TYPES
...
-- CREATING PHONE NUMBER TABLE FOR STORING MULTIPLE PHONE NUMBERS OF CUSTOMERS
CREATE TABLE PHONE_NO(
	PHONE_NO_ID INT NOT NULL AUTO_INCREMENT,
...
--CREATING ADDRESS TABLE TO STORE ADDRESS AS A WHOLE FOR BOTH CUSTOMER AND SHIPPING 
CREATE TABLE ADDRESS(
	ADDRESS_ID INT NOT NULL AUTO_INCREMENT,
    CUSTOMER_ID VARCHAR(10),
    SHIPPING_ID VARCHAR(10),
    PLOT_STREET_BUILDING_NO VARCHAR(10),
    FIRST_LINE VARCHAR(20) NULL,
    SECOND_LINE VARCHAR(20) NULL,
    PINCODE VARCHAR(10),
...
-- CREATING PRODUCT TABLE WITH APPROPRIATE DATA TYPES
...
-- CREATING INVOICE TABLE WITH APPROPRIATE DATA TYPES
...
-- CREATING ORDER_ITEM TABLE WITH APPROPRIATE DATA TYPES
...
-- CREATING CART TABLE WITH APPROPRIATE DATA TYPES
CREATE TABLE CART (
...
-- CREATING PAYMENT TABLE WITH APPROPRIATE DATA TYPES
...
-- CREATING SHIPPING TABLE WITH APPROPRIATE DATA TYPES
...
-- CREATING REVIEW TABLE WITH APPROPRIATE DATA TYPES
CREATE TABLE REVIEW (
...
-- CREATING WISHLIST TABLE WITH APPROPRIATE DATA TYPES
...
-- CREATING PROMOTION TABLE WITH APPROPRIATE DATA TYPES
...
INSERT INTO CUSTOMER (CUSTOMER_ID, NAME, EMAIL, PAYMENT_INFO)
VALUES
('CUST001', 'John Smith', 'john.smith@email.com', 'VISA'),
('CUST002', 'Jane Doe', 'jane.doe@email.com', 'MASTERCARD'),
('CUST003', 'Bob Johnson', 'bob.johnson@email.com', 'DISCOVER'),
('CUST004', 'Sara Lee', 'sara.lee@email.com', 'AMERICAN EXPRESS'),
('CUST005', 'David Brown', 'david.brown@email.com', 'VISA'),
('CUST006', 'Amy Davis', 'amy.davis@email.com', 'MASTERCARD'),
('CUST007', 'Mark Wilson', 'mark.wilson@email.com', 'DISCOVER'),
('CUST008', 'Karen Taylor', 'karen.taylor@email.com', 'AMERICAN EXPRESS'),
('CUST009', 'Mike Green', 'mike.green@email.com', 'VISA'),
('CUST010', 'Lisa Jackson', 'lisa.jackson@email.com', 'MASTERCARD');

-- INSTERTING VALUES IN PHONE NUMBER TABLE
INSERT INTO PHONE_NO (PHONE_NO_ID, CUSTOMER_ID, PHONE_NUMBER)
VALUES
('01', 'CUST001', '6775424587'),
('02', 'CUST002', '9873451290'),
('03', 'CUST003', '8760983456'),
('04', 'CUST004', '9081232309'),
('05', 'CUST005', '8760983412'),
('06', 'CUST006', '7653456409'),
('07', 'CUST007', '7765347886'),
('08', 'CUST008', '9876345600'),
('09', 'CUST009', '8765434567'),
('010', 'CUST010', '8762346789');

--INSETTING VALUES IN ADDRESS TABLE
INSERT INTO ADDRESS (ADDRESS_ID, CUSTOMER_ID, PLOT_STREET_BUILDING_NO, FIRST_LINE, SECOND_LINE, PINCODE )
VALUES
('01', 'CUST001', 123, 'Main', 'St', 600098),
('02', 'CUST002', 456, 'Oak', 'Ave', 602198),
('03', 'CUST003', 789, 'Maple', 'Dr', 612398),
('04', 'CUST004', 111, 'Cherry', 'Ln', 656798),
('05', 'CUST005', 222, 'Pine', 'St', 666668),
('06', 'CUST006', 333, 'Cedar', 'Ave', 696969),
('07', 'CUST007', 444, 'Elm', 'St', 654321),
('08', 'CUST008', 555, 'Birch', 'Dr', 600909),
('09', 'CUST009', 666, 'Oak', 'St', 611223),
('10', 'CUST010', 777, 'Maple', 'Ave', 657481);

-- INSERTING VALUES IN ADDRESS TABLE
INSERT INTO ADDRESS (ADDRESS_ID, SHIPPING_ID, PLOT_STREET_BUILDING_NO, FIRST_LINE, SECOND_LINE, PINCODE )
VALUES
('11', 1, 123, 'Main', 'St', 600098),
('12', 2, 456, 'Elm', 'St', 611223),
('13', 3, 789, 'Oak', 'St', 657481),
('14', 4, 987, 'Pine', 'St', 676668),
('15', 5, 321, 'Maple', 'St', 612398),
('16', 6, 654, 'Cedar', 'St', 602398),
('17', 7, 987, 'Elm', 'St', 612391),
('18', 8, 432, 'Oak', 'St', 612388),
('19', 9, 765, 'Pine', 'St', 612400),
('20', 10, 321, 'Birch', 'St', 612399);
...
INSERT INTO SHIPPING (SHIPPING_ID, TRACKING_NUM, SHIPPING_DATE, INVOICE_NO)
VALUES
(1, '123456789', '2022-01-20', 'INV001'),
(2, '234567890', '2022-01-21', 'INV002'),
(3, '345678901', '2022-01-22', 'INV003'),
(4, '456789012', '2022-01-23', 'INV004'),
(5, '567890123', '2022-01-24', 'INV005'),
(6, '678901234', '2022-01-25', 'INV006'),
(7, '789012345', '2022-01-26', 'INV007'),
(8, '890123456', '2022-01-27', 'INV008'),
(9, '901234567', '2022-01-28', 'INV009'),
(10, '012345678', '2022-01-29', 'INV010');
